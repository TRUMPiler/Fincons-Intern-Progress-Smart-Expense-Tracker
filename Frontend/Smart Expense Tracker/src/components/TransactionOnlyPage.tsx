...
const Transcation:FC=()=>
{
 ...
 const formatCurrency = (value:number) => {
  ...
  const handleCategoryChange = (e: any) => {
    ...
    return (
        <div className="flex flex-col md:flex-col justify-center w-full overflow-x-auto min-h-screen">
            <Toast ref={toast} />
            ...
            <Card>
            <DataTable paginator rows={5} value={transactions} stripedRows editMode="row" dataKey="_id" className="w-full border  border-black dark:border-white rounded-lg" onRowEditComplete={onRowEditComplete}>
                ...
                />
                <Column field="date" header="Date" editor={dateEditor} body={(row: TranscationType) => (row.date ? new Date(row.date).toLocaleString() : "")} />
